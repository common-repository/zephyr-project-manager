...
class Projects {
	...
	public static function get_projects($limit = null, $args = null, $filters = null, $public = false, $userId = null) {
		...
		$projects = $wpdb->get_results($wpdb->prepare($query, $prepare));
	...
	public static function get_project($project_id) {
		...
		if (is_object($project_id)) return $project_id;
							...
							<ul class="zpm_dropdown_list">
								<?php if (Utillities::canDeleteProject($userId, $project)) : ?>
									...
									<?php if ($project->archived) : ?>
										<li id="zpm-project-action__archive" data-archived="0"><?php esc_html_e('Unarchive Project', 'zephyr-project-manager'); ?></li>
									<?php else : ?>
										<li id="zpm-project-action__archive" data-archived="1"><?php esc_html_e('Archive Project', 'zephyr-project-manager'); ?></li>
									<?php endif; ?>
								<?php endif; ?>
								...
								<li id="zpm_export_project" class="zpm_dropdown_subdropdown"><?php esc_html_e('Export Project', 'zephyr-project-manager'); ?>
									<div class="zpm_export_dropdown zpm_submenu_item">
										<ul>
											<li id="zpm_export_project_to_csv" class="zpm_project_option_sub"><?php esc_html_e('Export to CSV', 'zephyr-project-manager'); ?></li>
											<li id="zpm_export_project_to_json" class="zpm_project_option_sub"><?php esc_html_e('Export to JSON', 'zephyr-project-manager'); ?></li>
										</ul>
									</div>
								</li>
				...
				<div class="zpm_project_body">
					<?php if (Projects::hasStatus($project)): ?>
						<div class="zpm-project-status">
							<span class="zpm-project-status-label" style="background: <?php echo esc_attr($status['color']); ?>"><?php echo esc_html($status['name']); ?></span>
						</div>
					<?php endif; ?>
							...
							<div class="zpm_project_avatar">
								...
								foreach ((array) $team as $member):
									...
									if (!Members::isTeam($member)) {
										...
										$team = Members::get_team($member); $color = zpm_get_primary_color(); $color = str_replace('#', '', $color); ?>
	
										<span class="zpm_avatar_container">
											<span class="zpm_avatar_background"></span>
											<span class="zpm_avatar_image" title="<?php echo esc_attr($team['name']); ?>" style="background-image: url('https://ui-avatars.com/api/?background=<?php echo $color; ?>&color=fff&name=<?php echo $team['name']; ?>');">
											</span>
										</span>
	...
	public static function has_project_access($project) {
        if (is_numeric($project)) $project = Projects::get_project($project);
		...
		$categories = $manager::get_categories(); ?>
			<div id="zpm_project_modal" class="zpm-modal" role="form" aria-label="<?php esc_attr_e('New Project', 'zephyr-project-manager') ?>" aria-modal="true" aria-hidden="true">
				<div class="zpm_modal_body">
					<h3><?php esc_html_e('Create a new project', 'zephyr-project-manager'); ?></h3><span class="zpm_close_modal lnr lnr-cross"></span>

					<div class="zpm-new-project__field">
						<label class="zpm_label" for="zpm-new-project--name"><?php esc_html_e('Project Name', 'zephyr-project-manager'); ?></label>
						<input class="zpm_project_name_input zpm_input" id="zpm-new-project--name" name="zpm_project_name" placeholder="<?php esc_html_e('Add a project name', 'zephyr-project-manager'); ?>" />
					</div>

					<div class="zpm-new-project__field">
						<label class="zpm_label" for="zpm-new-project--description"><?php esc_html_e('Project Description', 'zephyr-project-manager'); ?></label>
						<textarea id="zpm-new-project-description" id="zpm-new-project--description" class="zpm_input" placeholder="<?php esc_html_e('Project Description', 'zephyr-project-manager'); ?>"></textarea>
					</div>

					<div class="zpm-new-project__field">
						<label class="zpm_label" for="zpm-new-project__managers"><?php esc_html_e('Project Managers', 'zephyr-project-manager'); ?></label>
						<select id="zpm-new-project__managers" class="zpm_input zpm-input-chosen" multiple data-placeholder="<?php esc_html_e('Select Project Managers', 'zephyr-project-manager'); ?>">
					...
					<div class="zpm-new-project__field">
						<label class="zpm_label" for="zpm-new-task__status"><?php esc_html_e('Categories', 'zephyr-project-manager'); ?></label>
						<select id="zpm-new-project__categories" class="zpm_input zpm-input-chosen" multiple data-placeholder="<?php esc_html_e('Select Categories', 'zephyr-project-manager'); ?>">
							<?php foreach ($categories as $category) : ?>
					...
					<div class="zpm_modal_buttons">
						...
						<button id="zpm-new-project-priority" class="zpm_button zpm-priority-selection" zpm-toggle-dropdown="zpm-new-project-priority-dropdown" data-priority="priority_none"><span class="zpm-priority-name"><?php esc_html_e('Priority', 'zephyr-project-manager'); ?>: <?php esc_html_e('None', 'zephyr-project-manager'); ?></span>
							<div id="zpm-new-project-priority-dropdown" class="zpm-dropdown zpm-priority-dropdown">


								<div class="zpm-dropdown-item zpm-new-project-priority" data-value="priority_none" data-color="#f9f9f9"><span class="zpm-priority-indicator zpm-color-none"></span><?php esc_html_e('None', 'zephyr-project-manager'); ?></div>
						...
						<button id="zpm_modal_add_project" class="zpm_button"><?php esc_html_e('Create Project', 'zephyr-project-manager'); ?></button>

						<?php if (!BaseController::is_pro()) : ?>
							<p class="zpm-pro-upselling"><?php esc_html_e('Create Kanban-style board projects with the ', 'zephyr-project-manager'); ?> <a class="zpm-pro-link" href="https://zephyr-one.com/purchase-pro" target="_blank"><?php esc_html_e('Pro Version', 'zephyr-project-manager'); ?></a>.</p>
						<?php endif; ?>
					</div>
				</div>
			</div <?php
				...
				<div class="zpm-project-shortcode" data-project-id="<?php echo esc_attr($project->id); ?>" data-edit-project="<?php echo $a['edit'] ? 'true' : 'false'; ?>">
					<div class="zpm-project-card <?php echo esc_attr($classes); ?>">
						...
						<div class="zpm-project-card-body">
							...
							<?php if (Projects::hasStatus($project)) : ?>
							<div class="zpm-project-status">
								<span class="zpm-project-status-label" style="background: <?php echo !empty($status['color']) ? esc_attr($status['color']) : 'var(--zpm-primary-color)'; ?>; color: <?php echo esc_attr(Utillities::getTextColorBasedOnBackgroundColor($status['color'])); ?>;"><?php echo esc_html($status['name']); ?></span>
							</div>
						<?php endif; ?>
	...
	public static function isValid($project) {
		if (is_object($project)) return true;
		return false;
	}
